function [ret, AcqInfo, ChanInfo, TrigInfo] = gageSetup_TAM(handle, AcqInfo, ChanInfo)
...
for i = 1:sysInfo.ChannelCount
    ...
    chan(i).DirectAdc  = 0;
    chan(i).Filter     = 1;      % 15 to 6 mV noise using it if use 20 MHz transducer          %  5-Pole with -3dB point at 70 MHz;  1 turns on filter, 0 turns filter off (0 is default)
end
