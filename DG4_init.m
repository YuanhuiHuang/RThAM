function [DG4, DG4Info] = trigger_init()
...
DG4Info.Scope_Amplitude = 5; % Vpp.
DG4Info.Scope_Offset = 5; % Volt.
%
...
trig_outputImpedance(DG4,50,DG4Info.Scope_Channel);
