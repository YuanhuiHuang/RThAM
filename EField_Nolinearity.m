function EField_Max = EField_Nolinearity(dataName,IS_TA)
...
Slice_T1_Start=0e-6;  Slice_T1_End=0.5e-6;  % WOiLine
Slice_T2_Start=0.5e-6; Slice_T2_End=1e-6;
