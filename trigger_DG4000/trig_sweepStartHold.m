function Return = trig_sweepStartHold(trig,nStartHOldSecond,nChannel)
...
Command = ['SOURce' num2str(nChannel) ':SWEep:HTIMe:STARt'];
fwrite(trig,[Command ' ' num2str(nStartHOldSecond)]);
