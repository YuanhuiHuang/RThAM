...
inputRange = 10000;% [mV] 10000, 4000, 2000, 1000, 400, 200, 100
segCount = nAvg;
...
acqInfo.TriggerTimeout  = TriggerTimeout;                                              % Wait until trigger arrives [us] (-1: inf)
