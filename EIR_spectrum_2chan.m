...
saveName = 'Multi-2Channel-acquisition';
finalTime = datenum(clock + [0, 0, 1, -8, 0, 0]);
...
SS = zeros(1000,nPts,2);        % 3000 waveforms for 2 channels take 22.4 GB memory
...
% while counter <=0
    counter = counter + 1;
    tic;
    S = gageAcq2(DAQ, rawData, nAvg, acqMode);                            % Acquire Signals
    t_tot(i)=toc;
%     tic;
        for Chan=1:2
