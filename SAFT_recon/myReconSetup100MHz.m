...
det50.reconParams.GRID_DS = 5;
det50.reconParams.GRID_DZ = 1;
...
det50.reconParams.f_BPH      = [100 250]*1e6;
det50.reconParams.f_BPL      = [1 100]*1e6;
...
% det50.transducerParams.t_delay = 1e-6;                                 % Focal time (F/v_s + t_delay) [s]
% det50.transducerParams.F_TD  = 1.45e-3;                                      % Focal length of TD [m] 1.45 found in ss
det50.transducerParams.t_delay = 2.2e-6;                                 % Focal time (F/v_s + t_delay) [s]
det50.transducerParams.F_TD  = 3e-3;                                      % Focal length of TD [m] 1.45 found in ss
% V3330 0.237 inch
% V390 0.506 inch
det50.transducerParams.D_TD  = 3e-3;                                       % Diameter of TD active element [m] 
% V3330 0.25 inch
% V390 0.25 inch
det50.transducerParams.f_c   = 100e6;                                       % Central frequency [Hz] 
...
det50.transducerParams.transducer = '100';                                    % Transducer identifier
det50.transducerParams.t_foc      = 2.2e-6; % 1.705 / 8.520 is achieved by image details/contrast comparison of [8.46 8.64]
